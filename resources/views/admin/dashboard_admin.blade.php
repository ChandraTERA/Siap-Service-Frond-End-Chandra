...
@section('link-breadcrumb', 'Dashboard')
    ...
    <nav class="bg-white rounded-lg sticky top-3 z-10">
        <div class="flex flex-wrap items-center justify-between mx-auto p-4 py-7">
            ...
            <div class="flex flex-row items-center">    
                ...
                <div class="relative ">
                    <input type="text" class="p-1 md:px-2 lg:px-6 lg:w-64 md:w-36 bg-[#DCDCDC47] border-none appearance-none focus:outline-none active:outline-none focus:ring-1 focus:ring-[#00BF71] rounded-md placeholder:text-[#70707099] placeholder:text-sm" placeholder="Cari Id Transaksi">
        ...
        <article class="">
            <section >
                <div class="grid lg:grid-cols-3 gap-10">
                    <div class="bg-[#00BF71] rounded-md">
                        <div class="flex flex-row p-6 relative">
                            <div class="flex flex-col">
                                <span class="text-[#FAFAFA] mb-4">Pendapatan</span>
                                <span class="text-[#FAFAFA] text-lg font-semibold">RP 600.000,00</span>
                            </div>
                            <img src="./assets/image/money.png" alt="" class="absolute right-6">
                        </div>
                        <a href="/pendapatan-admin">
                            <div class="bg-[#04603A0D] border-t-2 border-[#0981504D] p-6 w-full text-[#FAFAFA] hover:bg-[#04603A] hover:border-[#098150] flex justify-between hover:rounded-b-md ">
                                <span class="">Lihat Selengkapnya</span>
                    ...
                    <div class="bg-[#00BF71] rounded-md">
                        <div class="flex flex-row p-6 relative">
                            <div class="flex flex-col">
                                <span class="text-[#FAFAFA] mb-4">Pendaftar Baru</span>
                                <span class="text-[#FAFAFA] text-lg font-semibold">RP 600.000,00</span>
                            </div>
                            <img src="./assets/image/vector2.png" alt="" class="absolute right-6">
                        </div>
                        <a href="/pendapatan-admin">
                            <div class="bg-[#04603A0D] border-t-2 border-[#0981504D] p-6 w-full text-[#FAFAFA] hover:bg-[#04603A] hover:border-[#098150] flex justify-between hover:rounded-b-md ">
                                <span class="">Lihat Selengkapnya</span>
                    ...
                    <div class="bg-[#00BF71] rounded-md">
                       <div class="flex flex-row p-6 relative">
                            <div class="flex flex-col">
                                <span class="text-[#FAFAFA] mb-4">Pengguna</span>
                                <span class="text-[#FAFAFA] text-lg font-semibold">RP 600.000,00</span>
                            </div>
                            <img src="./assets/image/vector2.png" alt="" class="absolute right-6">
                        </div>
            ...
            <section>
                <div class="bg-white rounded-md my-6 min-h-min md:overflow-y-auto">
                    <table class="min-w-full mx-auto">
                        <thead class="sticky top-0 z-10">                           
                            <tr class="bg-[#00BF71]" >
                                <th class="px-4 py-4 text-center font-medium text-[#FFFFFF] ">ID Transaksi</th>
                                <th class="px-4 py-4 text-center font-medium text-[#FFFFFF]">Nama</th>
                                <th class="px-4 py-4 text-center font-medium text-[#FFFFFF]">Jenis Barang</th>
                                <th class="px-4 py-4 text-center font-medium text-[#FFFFFF]">Total Pembayaran</th>
                                <th class="px-4 py-4 text-center font-medium text-[#FFFFFF]">Status</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="bg-[#FAFAFA]">
                                <td class="px-4 py-4 text-center text-silver-50 font-medium">1</td>
                                <td class="px-4 py-4 text-center text-silver-50">Rangga Andika</td>
                                <td class="px-4 py-4 text-center text-silver-50">13/4/2023</td>
                                <td class="px-4 py-4 text-center text-silver-50">Rp. 800.000</td>
                                <td class="px-4 py-4 text-center text-silver-50">
                                    <a href="/pengguna-admin">

                                        <div class="bg-[#00BF71] hover:bg-[#04603A] text-white rounded-md flex justify-center py-2">
                            ...
                            <tr class="bg-[#FAFAFA]">
                                <td class="px-4 py-4 text-center text-silver-50 font-medium">2</td>
                                <td class="px-4 py-4 text-center text-silver-50">Rangga Andika</td>
                                <td class="px-4 py-4 text-center text-silver-50">13/4/2023</td>
                                <td class="px-4 py-4 text-center text-silver-50">Rp. 800.000</td>
                                <td class="px-4 py-4 text-center text-silver-50">
