...
@section('link-breadcrumb', 'Pengguna')

@section('navbar')
    <nav class="bg-white rounded-lg sticky top-3 z-10">
        <div class="flex flex-wrap items-center justify-between mx-auto p-4 py-7">
            ...
            <div class="flex flex-row items-center">    
                ...
                <div class="relative ">
                    <input type="text" class="p-1 md:px-2 lg:px-6 lg:w-64 md:w-36 bg-[#DCDCDC47] border-none appearance-none focus:outline-none active:outline-none focus:ring-1 focus:ring-[#00BF71] rounded-md placeholder:text-[#70707099] placeholder:text-sm" placeholder="Cari Id Pengguna">
                    <button type="submit" class="absolute right-5 top-1.5 text-[#C6C6C6] text-sm">
                        <i class="fas fa-search "></i>
                    </button>
                </div>    
                <div class="mx-4 flex flex-row gap-3 items-center">
                    <div class="relative w-8">
                        <input type="text" datepicker datepicker-autohide class="absolute right-2.5 pr-2 pl-2 bottom-1.5 w-4 h-4 flex items-center cursor-pointer bg-transparent focus:outline-none focus:text-transparent focus:ring-0 focus:appearance-none border-none">
                        <img src="./assets/image/svg/mdi_calendar.svg" alt="" class="">
                    </div>
                ...
                <div class="absolute right-10">
                    <img src="./assets/image/logo2.png" alt="" class="w-16">
                </div>
            </div>
        </div>
    </nav>
@endsection
    ...
    <main class=" ">
        <article class="">
            {{-- <section class="flex flex-row items-center bg-[#FAFAFA] my-6 p-4 py-5 rounded-md "> 
                <div class="flex flex-row items-center ">    
                    <span class="mx-6 text-base  text-silver-50">Pengguna</span>
                    <div class="relative ">
                        <input type="text" class="p-1 px-6 w-64 bg-[#DCDCDC47] border-none appearance-none focus:outline-none active:outline-none focus:ring-1 focus:ring-[#00BF71] rounded-md placeholder:text-[#70707099] placeholder:text-sm" placeholder="Cari Id Pengguna">
                        <i class="fas fa-search absolute right-5 top-1.5 text-[#C6C6C6] text-sm"></i>
                    </div>    
                    <div class="mx-3 flex flex-row gap-3 items-center">
                        <div class="relative w-6">
                            <input type="text"datepicker datepicker-autohide class="absolute right-1 pr-2 pl-2 bottom-1 w-4 h-4 flex items-center cursor-pointer bg-transparent focus:outline-none focus:text-transparent focus:ring-0 border-none ">
                            <img src="./assets/image/svg/mdi_calendar.svg" alt="" class="">
                        </div>
                                            
                        <a href="/notifikasi-pembayaran" class="text-lg">
                            <i class="fa-regular fa-bell text-[#C6C6C6] "></i>
                        </a>
                    </div>
                    <div class="absolute right-10">
                        <img src="./assets/image/logo2.png" alt="" class="w-16">
            ...
            <section>
                <div class="bg-white rounded-md md:overflow-y-auto">
                    <table class="min-w-full mx-auto">
                        <thead class="sticky top-0 z-10">                           
                            <tr class="bg-[#00BF71]" >
                                <th class="px-4 py-2 text-center font-medium text-[#FFFFFF]">ID Pengguna</th>
                                <th class="px-4 py-2 text-center font-medium text-[#FFFFFF]">Nama</th>
                                <th class="px-4 py-2 text-center font-medium text-[#FFFFFF]">Alamat</th>
                                <th class="px-4 py-2 text-center font-medium text-[#FFFFFF]">No.Telp</th>
                                <th class="px-4 py-2 text-center font-medium text-[#FFFFFF]">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="bg-[#FAFAFA]">
                                <td class="px-4 py-2 text-center text-silver-50">ZXCVBH6785</td>
                                <td class="px-4 py-2 text-center text-silver-50">Biru Muluk</td>
                                <td class="px-4 py-2 text-center text-silver-50">Yogyakarta</td>
                                <td class="px-4 py-2 text-center text-silver-50">089 - 9378 - 8192</td>
                                <td class="px-4 py-2 text-center text-silver-50">
                                    <a href="/detail-pengguna" >
                                        <div class=" text-light rounded-md flex justify-center ">
                                            <div class="p-1 px-6 bg-main rounded-md  hover:bg-[#008753] hover:text-[#FFFFFF]">
                    ...
                    {{-- Pagination --}}
                    <div class="rounded-md py-3 bg-[#FAFAFA] ">
                        <div class="flex flex-row bg-[#FAFAFA] justify-between ">
                            <div class="mx-20">
                                <div class="border-[#707070] border-opacity-40 border-2 text-silver-50 text-opacity-70 rounded-md px-4 py-0.5">
                                    <span >Halaman 1</span>
                                </div>
                            </div>
                            <div class="mx-20">
                                <div class="flex bg-[#E5E9EE] rounded-md">
                                    {{-- Previous Button --}}
                                    <button
                                        class="text-silver-50  hover:text-silver-50 hover:bg-gray-100 bg-[#E5E9EE] py-1 px-3 w-8 flex justify-center rounded-l">&lt;</button>
                                    <hr class="border-r-2 h-8 border-[#D4DAE3]">
                                    {{-- Page Numbers --}}
                                    <button
                                        class="text-silver-50 hover:bg-gray-100 hover:text-silver-50  py-1 px-3 w-8 flex justify-center {{ request()->is('pengguna-admin') ? 'bg-emerald-500 text-white' : '' }}">1</button>
                                    <hr class="border-r-2 h-8 border-[#D4DAE3]">
                                    <button
                                        class="hover:bg-gray-100  hover:text-silver-50 text-silver-50 py-1 px-3 w-8 flex justify-center {{ request()->is('') ? 'bg-emerald-500 text-white' : '' }}">2</button>
                                    <hr class="border-r-2 h-8 border-[#D4DAE3]">
                                    <button
                                        class="hover:bg-gray-100  hover:text-silver-50 text-silver-50 py-1 px-3 w-8 flex justify-center {{ request()->is('') ? 'bg-emerald-500 text-white' : '' }}">3</button>
                                    <hr class="border-r-2 h-8 border-[#D4DAE3]">
                                    {{-- Next Button --}}
                                    <button
                                        class="bg-[#E5E9EE] hover:bg-gray-100 text-silver-50  hover:text-silver-50 py-1 px-3 w-8 justify-center rounded-r">&gt;</button>
                                </div>
                            </div>
                        </div>            
                    </div>
