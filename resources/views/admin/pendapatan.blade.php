...
@section('link-breadcrumb', 'Pendapatan')
                    ...
                    <li>
                        <div class="flex items-center">
                            <a href="/dashboard-admin"
                                ...
                                <img src="./assets/image/svg/back.svg" alt="" class="">
                            </a>
                        </div>
                    </li>
        ...
        <article class="">
            {{-- <section class="flex flex-row items-center bg-[#FAFAFA] my-6 p-4 py-6 rounded-md "> 
                <div class="flex flex-row items-center ">    
                    <a href="/dashboard-admin" class="ml-6 text-xl text-silver-50">
                        <img src="./assets/image/svg/back.svg" alt="" class="w-5">
                    </a>
                    <span class="mx-3 text-base  text-silver-50">Dashboard</span>
                ...
                <div class="gap-4 flex flex-row ">
                    <div date-rangepicker class="flex items-center gap-4">
                        <div class="relative flex flex-col gap-2">
                            <span class="text-silver-50">Tanggal Dimulai</span>
                            <div class="absolute right-4 bottom-2 flex items-center pointer-events-none">
                                <img src="./assets/image/svg/mdi_calendar.svg" alt="" class="w-6">
                            </div>
                        <input name="start" type="text" class="bg-gray-50 border-none focus:ring-emerald-500 text-silver-50 text-sm rounded-lg block w-full pl-4 p-2.5  dark:bg-[#FFFFFF] dark:placeholder-text-silver-50  " placeholder="Tanggal Dimulai">
                        </div>
                        <div class="relative flex flex-col gap-2">
                            <span class="text-silver-50">Tanggal Terakkhir</span>
                            <div class="absolute right-4 bottom-2 flex items-center pointer-events-none">
                                <img src="./assets/image/svg/mdi_calendar.svg" alt="" class="w-6">
                            </div>
                        <input name="end" type="text" class="bg-gray-50 border-none focus:ring-emerald-500 text-silver-50 text-sm rounded-lg block w-full pl-4 p-2.5  dark:bg-[#FFFFFF] dark:placeholder-text-silver-50  " placeholder="Tanggal Terakhir">
                        </div>
                    </div>
                </div>
                <div class="flex mt-8 mb-3 items-center">
                    <a href="" class="bg-white flex flex-row px-4 rounded-md items-center gap-6 p-2.5">
                        <img src="./assets/image/svg/download.svg" alt="" class="text-sm text-silver-50 opacity-80">
                        <div class="text-silver-50 text-sm ">Cetak Laporan</div>
                    </a>
                </div>
            </section>
            <section>
                <div class="bg-[#FAFAFA] rounded-md my-6 md:overflow-y-auto">
                    <table class="min-w-full mx-auto">
                        <thead class="sticky top-0 z-10">                           
                            <tr class="bg-[#00BF71]" >
                                <th class="px-4 py-2 text-center font-medium text-[#FFFFFF]">Tanggal</th>
                                <th class="px-4 py-2 text-center font-medium text-[#FFFFFF]">ID Transaksi</th>
                                <th class="px-4 py-2 text-center font-medium text-[#FFFFFF]">Layanan</th>
                                <th class="px-4 py-2 text-center font-medium text-[#FFFFFF]">Rekening</th>
                                <th class="px-4 py-2 text-center font-medium text-[#FFFFFF]">Pendapatan</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="bg-[#FAFAFA]">
                                <td class="px-4 py-2 text-center text-silver-50 font-medium">20/10/2022</td>
                                <td class="px-4 py-2 text-center text-silver-50">ZXCVBH6785</td>
                                <td class="px-4 py-2 text-center text-silver-50">Service</td>
                                <td class="px-4 py-2 text-center text-silver-50">BCA</td>
                                <td class="px-4 py-2 text-center text-silver-50">Rp 2.000.000</td>
                            </tr>             
                            <tr class="bg-[#FAFAFA]">
                                <td class="px-4 py-2 text-center text-silver-50 font-medium">20/10/2022</td>
                                <td class="px-4 py-2 text-center text-silver-50">ZXCVBH6785</td>
                    ...
                    {{-- Pagination --}}
                    <div class="rounded-md my-12 bg-[#FAFAFA]">
                        <div class="flex flex-row bg-[#FAFAFA] justify-between ">
                            ...
                            <div class="mx-20">
                                <div class="flex bg-[#E5E9EE] rounded-md">
                                    ...
                                    {{-- Page Numbers --}}
                                    <button
                                        class="text-silver-50 hover:bg-gray-100 hover:text-silver-50  py-1 px-3 w-8 flex justify-center {{ request()->is('pendapatan-admin') ? 'bg-emerald-500 text-white' : '' }}">1</button>
                                    <hr class="border-r-2 h-8 border-[#D4DAE3]">
                                    <button
