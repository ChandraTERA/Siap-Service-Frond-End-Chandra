...
@section('title', 'Notifikasi Validasi Pembayaran')
@section('link-breadcrumb', 'Notifikasi Validasi Pembayaran')
                ...
                <ul
                    ...
                    <li class="flex items-center">
                        {{-- <a href="/notifikasi-pembayaran"> --}}
                            ...
                            <img src="./assets/image/svg/notifgreen.svg" alt="" class="cursor-not-allowed">
                        {{-- </a> --}}
        ...
        <article class="">
            {{-- <section class="flex flex-row items-center bg-[#FAFAFA] my-6 p-4 py-6 rounded-md "> 
                <div class="flex flex-row items-center ">    
                    ...
                    <span class="mx-3 text-base  text-silver-50">Notifikasi Validasi Pembayaran</span>
                    <a href="/notifikasi-pembayaran" class="absolute right-40 text-lg">
                        <i class="fa-solid fa-bell text-[#C6C6C6] {{ request()->is('notifikasi-pembayaran') ? 'text-emerald-500' : '' }}"></i>
                    </a>
            ...
            <section class="flex justify-end">
                <div class="relative">
                    ...
                    <input datepicker datepicker-buttons type="text" class="border-none focus:ring-1 text-silver-50 placeholder-[#707070]   focus:ring-emerald-500 text-sm rounded-lg block w-full pl-4 p-2.5" placeholder="Pilih Tanggal">
                </div>
            </section>
            <section>
                <ul>
                    <li>
                        <div class="bg-[#FAFAFA] my-6 p-3 rounded-md justify-between flex flex-row">
                            <div class="gap-4 flex flex-row items-center">
                                <img src="./assets/image/avatar/p1.png" alt="profile" class="w-10">
                                <span class="text-sm text-[#6E6E6E] ">Biru Muluk Hadiawan</span>
                                <span class="text-sm text-[#484848] font-semibold">Request Validasi Pembayaran</span>
                            </div>
                            <div class="flex items-center">
                                <span class="text-[#6E6E6E]" >14.25</span>
                            </div>
                        </div>
                    </li>
                    <li>
            ...
            <section>
                 {{-- Pagination --}}
                 <div class="rounded-md py-3 my-4 ">
                    <div class="flex flex-row justify-between ">
                        ...
                        <div class="mx-20">
                            <div class="flex bg-[#E5E9EE] rounded-md">
                                ...
                                {{-- Page Numbers --}}
                                <button
                                    class="text-silver-50 hover:bg-gray-100 hover:text-silver-50  py-1 px-3 w-8 flex justify-center {{ request()->is('notifikasi-pembayaran') ? 'bg-emerald-500 text-white' : '' }}">1</button>
                                <hr class="border-r-2 h-8 border-[#D4DAE3]">
                                <button
