    ...
    @section('contents')
        ...
        <form action="" method="" class="flex flex-col mt-8 relative">
            ...
            <div class="flex justify-between items-center mt-8">
                ...
                <a href="/edit-metode-pembayaran" class="flex items-center text-black hover:text-main">
                    <span class="w-24 cursor-pointer">ganti metode pembayaran</span>
            ...
            <div class="flex justify-between items-center mt-8">
                ...
                <div class="flex gap-2">
                    <img src="./assets/svg/pembayaran/BRI.svg" alt="pembayaran">
                    <span>BRI</span>
                </div>
            </div>
            <div class="flex justify-between items-center mt-32">
                ...
                <button type="submit" class="btn-main w-1/3 cursor-pointer">Bayar</button>
            </div>
        </form>
