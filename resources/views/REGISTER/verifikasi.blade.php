...
<body>
    ...
    {{-- Verifikasi --}}
    <div class="grid grid-rows-5 container max-h-[844px]  ">

        <div class=" mx-auto mr-12 mt-6">  <img src="../asset/img/LOGO.png" alt="Logo" class="w-[87px] h-[75px]"></div>
        <div class=" mx-auto -mt-20"><img src="../asset/img/amico.png" class="w-[280px] h-[284px]" alt="logoverif"></div>
        ...
        <div class="grid grid-cols-4 gap-7 mt-6 mx-auto">
